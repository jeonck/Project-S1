...
export const DataProvider = ({ children }) => {
  ...
  const initializeLocalStorage = () => {
    ...
    const DATA_VERSION = '3.1'; // 소속을 '카미노'로 변경
    ...
    if (!localStorage.getItem('teamMembers')) {
      const initialTeamMembers = [
        { id: 'tm1', name: '고재환', department: '카미노', role: '' },
        { id: 'tm2', name: '김기홍', department: '카미노', role: '' },
        { id: 'tm3', name: '김연식', department: '카미노', role: '' },
        { id: 'tm4', name: '김영빈', department: '카미노', role: '' },
        { id: 'tm5', name: '김상협', department: '카미노', role: '' },
        { id: 'tm6', name: '김선미', department: '카미노', role: '' },
        { id: 'tm7', name: '최수석', department: '카미노', role: '' },
        { id: 'tm8', name: '김명현', department: '카미노', role: '' },
        { id: 'tm9', name: '김상현', department: '카미노', role: '' },
        { id: 'tm10', name: '이상인', department: '카미노', role: '' },
        { id: 'tm11', name: '강희태', department: '카미노', role: '' },
        { id: 'tm12', name: '김다정', department: '카미노', role: '' },
        { id: 'tm13', name: '김종우', department: '카미노', role: '' },
        { id: 'tm14', name: '박강효', department: '카미노', role: '' },
        { id: 'tm15', name: '박규효', department: '카미노', role: '' },
        { id: 'tm16', name: '박다솜', department: '카미노', role: '' },
        { id: 'tm17', name: '박세현', department: '카미노', role: '' },
        { id: 'tm18', name: '박용진', department: '카미노', role: '' },
        { id: 'tm19', name: '변원규', department: '카미노', role: '' },
        { id: 'tm20', name: '서동린', department: '카미노', role: '' },
        { id: 'tm21', name: '서우석', department: '카미노', role: '' },
        { id: 'tm22', name: '유순학', department: '카미노', role: '' },
        { id: 'tm23', name: '윤석원', department: '카미노', role: '' },
        { id: 'tm24', name: '이용준', department: '카미노', role: '' },
        { id: 'tm25', name: '이철희', department: '카미노', role: '' },
        { id: 'tm26', name: '임소영', department: '카미노', role: '' },
        { id: 'tm27', name: '전창국', department: '카미노', role: '' },
        { id: 'tm28', name: '조길제', department: '카미노', role: '' },
        { id: 'tm29', name: '최윤경', department: '카미노', role: '' },
        { id: 'tm30', name: '최학원', department: '카미노', role: '' },
        { id: 'tm31', name: '허상무', department: '카미노', role: '' },
        { id: 'tm32', name: '황용철', department: '카미노', role: '' },
      ];
